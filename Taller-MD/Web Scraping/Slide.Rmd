...
```{r Gtrends,eval=FALSE,echo=FALSE,cache=FALSE,message=FALSE,warning=FALSE,out.height="550px", out.width="750px"}
...
.pull-right[![Ciencia de datos en el contexto de procesos estrechamente relacionados en la organización.](https://www.liebertpub.com/cms/10.1089/big.2013.1508/asset/images/medium/figure1.gif)]
---
class: inverse, bottom, center, middle
# ¿Ciencia de datos la profesión más sexy del siglo XXI?
.pull-left[![](imagen/DSexyGlobalPais.png) ![](imagen/DSexyMundoContacto.png)]

.pull-right[![](imagen/DSexyEconomista.png) ![](imagen/DSexyInfobae.png)]
